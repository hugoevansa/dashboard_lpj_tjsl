...
<div class="page-header">
    ...
    <div>
        ...
        <div class="page-header-sub">Menampilkan seluruh data bantuan</div>
    </div>
</div>
""", unsafe_allow_html=True)
...
st.markdown(
    f'<div class="section-sub">Menampilkan {len(table_df)} data penerima bantuan</div>',
    unsafe_allow_html=True
)
...
disp = disp[
    [
        "Nama Bantuan", "Jumlah Bantuan (Rp)", "Tanggal Dibantu", "Tenggat",
        "PIC", "No Hp Penerima", "Tahun", "Aksi Chat", "Status"
    ]
]
